...
注意:
  ...
  实测后再决定是否加保护模块（见 ``auto-turret-1130/project-spec.json``）。
...
.. code-block:: powershell
    ...
    cd F:\Productive\DIY\Zephyr_card\zephyrproject\zephyr
    F:\Productive\DIY\Zephyr_card\zephyrproject\.venv\Scripts\Activate.ps1
